        ...
        <div id="user-box">
            ...
            (<div>
                <div id="user-profile-menu">
                    <Link to={"/profile/" + user?._id}><div className='option'><FontAwesomeIcon icon={faAddressCard} /><p>Profil</p></div></Link>
                    <Link to="/settings"><div className='option'><FontAwesomeIcon icon={faGear} />Nastavitve</div></Link>
                    <div className='option' onClick={logout}><FontAwesomeIcon icon={faRightFromBracket} />Odjava</div>
                </div>
            </div>)
            :
            (<></>)}
